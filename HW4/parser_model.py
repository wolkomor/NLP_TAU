...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden.weight = torch.nn.init.xavier_uniform_(self.embed_to_hidden.weight)
        ...
        self.hidden_to_logits.weight = torch.nn.init.xavier_uniform_(self.hidden_to_logits.weight)
